       ...
       <!-- /.card -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
                <form action="/categoria/<?= $categoria["id"]; ?>/edit" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Estado</label>
                    <input name="estado" value="<?= $categoria["estado"]; ?>" type="text" class="form-control">
                  </div>

                  <div class="form-group">
                    <label>Imagen</label>
                    <input name="imagen" value="<?= $categoria["imagen"]; ?>" type="text" class="form-control">
                  </div>
